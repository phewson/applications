...
![](../../course/intro/cache/scatterplot.html){width="100%" height="600px"}
...
#| eval: true
#| results: 'asis'
with open('../../course/intro/cache/correlation.txt') as f:
    content = f.read()
...
#| eval: true
#| results: 'asis'
with open('../../course/intro/cache/regression_summary.txt') as f:
    content = f.read()
    print(content)
```
